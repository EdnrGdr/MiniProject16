public class Idman {
    ...
    public void burpeeYap(int sayi) {
        ...
        if (burpee_sayisi - sayi < 0 ) {
            ...
            burpee_sayisi-= sayi;
            System.out.println("Kalan Burpe Sayısı : " + burpee_sayisi);
        }
    ...
    public void pushupYap(int sayi) {
        ...
        if (pushup_sayisi - sayi < 0 ) {
            ...
            System.out.println("Hedeflenen pushUp Sayısı Geçildi..Tebrikler!");
            pushup_sayisi=0;
    ...
    public void Situp(int sayi) {
        ...
        if (situp_sayisi - sayi < 0 ) {
            ...
            System.out.println("Hedeflenen Situp Sayısı Geçildi..Tebrikler!");
            situp_sayisi=0;
    ...
    public boolean idmanBittimi () {
        ...
        return ( burpee_sayisi==0) && (pushup_sayisi==0) && (situp_sayisi==0) && (squat_sayisi==0);      // Hepsi 0 a esit olunca true değer dönecek idman bitti anlamındadır.
